...
copy .\mkl\blas-lapack-wrapper\lib\*.lib %NELSON_DIR%\bin\%PLATFORM_NELSON%\mkl\*.lib
...
copy .\mkl\blas-lapack-wrapper\lib\*.lib %NELSON_DIR%\bin\%PLATFORM_NELSON%\*.lib
